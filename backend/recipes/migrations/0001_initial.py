    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(help_text='Цвет в HEX-формате, например: #AABBCC', max_length=7, validators=[django.core.validators.RegexValidator(message='Неверный формат цвета. ', regex='^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$')], verbose_name='Цвет')),
